...
public:
  explicit IOMXBufferSourceDelegator(const ::android::sp<IOMXBufferSource> &impl) : _aidl_delegate(impl) {}

  ::android::sp<IOMXBufferSource> getImpl() { return _aidl_delegate; }
