...
$(call INFO,$(MODULE),processing dependencies,$(DEPENDENCY_MODULE))
...
SAVED_$(MODULE)_RUST_STEM := $(MODULE_RUST_STEM)
...
# make/aidl.mk variables
SAVED_$(MODULE)_MODULE_AIDLS := $(MODULE_AIDLS)
SAVED_$(MODULE)_MODULE_AIDL_INCLUDES := $(MODULE_AIDL_INCLUDES)
SAVED_$(MODULE)_MODULE_AIDL_FLAGS := $(MODULE_AIDL_FLAGS)
SAVED_$(MODULE)_MODULE_AIDL_PACKAGE := $(MODULE_AIDL_PACKAGE)
SAVED_$(MODULE)_MODULE_AIDL_LANGUAGE := $(MODULE_AIDL_LANGUAGE)
SAVED_$(MODULE)_MODULE_AIDL_RUST_DEPS := $(MODULE_AIDL_RUST_DEPS)
...
MODULE_RUST_STEM := $(SAVED_$(MODULE)_RUST_STEM)
...
# make/aidl.mk variables
MODULE_AIDLS := $(SAVED_$(MODULE)_MODULE_AIDLS)
MODULE_AIDL_INCLUDES := $(SAVED_$(MODULE)_MODULE_AIDL_INCLUDES)
MODULE_AIDL_FLAGS := $(SAVED_$(MODULE)_MODULE_AIDL_FLAGS)
MODULE_AIDL_PACKAGE := $(SAVED_$(MODULE)_MODULE_AIDL_PACKAGE)
MODULE_AIDL_LANGUAGE := $(SAVED_$(MODULE)_MODULE_AIDL_LANGUAGE)
MODULE_AIDL_RUST_DEPS := $(SAVED_$(MODULE)_MODULE_AIDL_RUST_DEPS)
...
$(call INFO_DONE_SILENT,$(MODULE),processing dependencies,$(DEPENDENCY_MODULE))
