...
private:
    ...
    // 0 = not yet detected, INT64_MAX = waiting for boot/provisioning/setup wizard,
    // >0 = real deadline, -1 = done (HWC re-enabled).
    std::atomic<nsecs_t> mMtkBootGpuCompDeadline{0};
