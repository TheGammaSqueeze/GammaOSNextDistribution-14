...
static const Ps3DataItem kThemeSettingsCh[] = {
  ...
  {"Long Names",22,"Minima theme only: how a game or app name too long for its row is shown. Shrink to Fit reduces the font so the whole name fits; Scroll keeps the normal font size, scrolling the focused name and clipping the others at the edge.","Shrink to Fit",1,nullptr,0},
