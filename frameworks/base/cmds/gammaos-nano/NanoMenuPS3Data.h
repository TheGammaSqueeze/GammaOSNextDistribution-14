...
static const Ps3DataItem kThemeSettingsCh[] = {
  ...
  {"Half Resolution: Icons",22,"XMB theme only: renders the glass home icons at half resolution and upscales them smoothly. Menu text stays sharp. Helps most on devices where the glass effect is heavy.","Off",1,nullptr,0},
