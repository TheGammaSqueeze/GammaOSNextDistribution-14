...
/** Quick settings tile: DualStack **/
public class DualStackTile extends QSTileImpl<BooleanState> {
 
    // Target activity for both long-press and chevron/side-action.
    private static final String TARGET_PKG = "com.gammaos.dualstackcontrol";
    private static final String TARGET_CLS = "com.gammaos.dualstackcontrol.MainActivity";

    public static final String TILE_SPEC = "dualstack";

    private static final String PROP_CONTROL = "persist.gammaos.dualstack.enabled";
    ...
    private void applyState(int state) {
        ...
        if (Log.isLoggable("DualStackTile", Log.DEBUG)) {
            Log.d("DualStackTile", "Applied DualStack control: " + mode);
        }
    }
