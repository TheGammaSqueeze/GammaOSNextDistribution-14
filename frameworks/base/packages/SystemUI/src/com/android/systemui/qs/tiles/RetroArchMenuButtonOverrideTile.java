...
public class RetroArchMenuButtonOverrideTile extends QSTileImpl<BooleanState> {
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        state.label = mContext.getString(R.string.quick_settings_retroarch_override_label);
    ...
    public CharSequence getTileLabel() {
        return mContext.getString(R.string.quick_settings_retroarch_override_label);
    }
