...
public class RightAnalogAxisTile extends QSTileImpl<BooleanState> {
    ...
    private static final String PROP = "persist.gammaos.gamepad.invert_right";
    ...
    public RightAnalogAxisTile(
        ...
        mEnabled = SystemProperties.getInt(PROP, 0) != 0;
    }
    ...
    protected void handleSetListening(boolean listening) {
        ...
        if (listening) {
            boolean newEnabled = SystemProperties.getInt(PROP, 0) != 0;
    ...
    protected void handleClick(@Nullable View view) {
        mEnabled = !mEnabled;
        SystemProperties.set(PROP, mEnabled ? "1" : "0");
        bumpConfigVersion();
        refreshState();
    }
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        if (mEnabled) {
            state.label = mContext.getString(R.string.quick_settings_right_stick_on);
            state.icon  = mIconOn;
            state.state = Tile.STATE_ACTIVE;
        } else {
            state.label = mContext.getString(R.string.quick_settings_right_stick_off);
            state.icon  = mIconOff;
    ...
    public CharSequence getTileLabel() {
        return mContext.getString(R.string.quick_settings_right_stick_label);
    }
    ...
    private void bumpConfigVersion() {
        int ver = SystemProperties.getInt(PROP_CONFIG_VERSION, 0);
        SystemProperties.set(PROP_CONFIG_VERSION, Integer.toString(ver + 1));
    }
}
