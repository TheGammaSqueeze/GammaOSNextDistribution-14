...
/** Quick settings tile: GammaOS Launch Guard */
public class LaunchGuardTile extends QSTileImpl<BooleanState> {

    // Target activity for both long-press and chevron/side-action.
    private static final String TARGET_PKG = "com.gammaos.launchguardcontrol";
    private static final String TARGET_CLS = "com.gammaos.launchguardcontrol.MainActivity";

    public static final String TILE_SPEC = "launchguard";

    private static final String PROP_CONTROL = "persist.gammaos.launch.guard.enabled";
    ...
    private final Icon mIconOn  = ResourceIcon.get(R.drawable.ic_qs_sync);
    private final Icon mIconOff = ResourceIcon.get(R.drawable.ic_qs_cancel);
    private final Receiver mReceiver = new Receiver();

    @Inject
    public LaunchGuardTile(
            QSHost host,
    ...
    private void applyState(int state) {
        ...
        if (Log.isLoggable("LaunchGuardTile", Log.DEBUG)) {
            Log.d("LaunchGuardTile", "Applied Launch Guard: " + mode);
        }
    }
