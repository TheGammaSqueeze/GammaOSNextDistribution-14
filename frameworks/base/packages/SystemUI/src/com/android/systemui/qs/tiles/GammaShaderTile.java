...
/** Quick settings tile: GammaShader **/
public class GammaShaderTile extends QSTileImpl<BooleanState> {
 
    // Target activity for both long-press and chevron/side-action.
    private static final String TARGET_PKG = "com.gammaos.shadercontrol";
    private static final String TARGET_CLS = "com.gammaos.shadercontrol.MainActivity";

    public static final String TILE_SPEC = "gammashader";

    private static final String PROP_CONTROL = "persist.gammaos.shader.enable";
    ...
    public CharSequence getTileLabel() {
        return mContext.getString(R.string.quick_settings_gamma_shader_label);
    }
    ...
    private void applyState(int state) {
        ...
        if (Log.isLoggable("GammaShaderTile", Log.DEBUG)) {
            Log.d("GammaShaderTile", "Applied GammaShader control: " + mode);
        }
    }
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        if (currentState == STATE_ENABLED) {
            state.label = mContext.getString(R.string.quick_settings_gamma_shader_label);
            state.icon  = mIconOn;
