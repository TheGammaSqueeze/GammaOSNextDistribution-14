...
public class GammaDualFocusTile extends QSTileImpl<BooleanState> {

    public static final String TILE_SPEC = "gammadualfocus";

    private static final String PROP_CONTROL = "persist.gammaos.multidisplay.dual_focus";
    ...
    private void applyState(int state) {
        ...
        if (Log.isLoggable("GammaDualFocusTile", Log.DEBUG)) {
            Log.d("GammaDualFocusTile", PROP_CONTROL + "=" + state);
        }
    }
