...
import com.android.systemui.qs.tiles.ScreenMapTile;
...
interface LineageModule {
    ...
    /** Inject ImmersiveModeTile into tileMap in QSModule */
    @Binds
    @IntoMap
    ...
    /** Inject GammaDualFocusTile into tileMap in QSModule */
    @Binds
    @IntoMap
    @StringKey(GammaDualFocusTile.TILE_SPEC)
    fun bindGammaDualFocusTile(gammadualFocusTile: GammaDualFocusTile): QSTileImpl<*>

    /** Inject GammaSecondaryDisplayTile into tileMap in QSModule */
    @Binds
    @IntoMap
    @StringKey(GammaSecondaryDisplayTile.TILE_SPEC)
    fun bindGammaSecondaryDisplayTile(gammaSecondaryDisplayTile: GammaSecondaryDisplayTile): QSTileImpl<*>
    ...
    /** Inject ScreenMapTile into tileMap in QSModule */
    @Binds
    @IntoMap
    @StringKey(ScreenMapTile.TILE_SPEC)
    fun bindScreenMapTile(screenMapTile: ScreenMapTile): QSTileImpl<*>
