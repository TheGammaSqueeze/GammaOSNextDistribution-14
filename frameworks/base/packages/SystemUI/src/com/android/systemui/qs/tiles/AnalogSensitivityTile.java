...
public class AnalogSensitivityTile extends QSTileImpl<BooleanState> {
    ...
    private static final String PROP = "persist.gammaos.gamepad.global_sensitivity";
    ...
    public AnalogSensitivityTile(
        ...
        currentState = SystemProperties.getInt(PROP, 0);
    }
    ...
    protected void handleSetListening(boolean listening) {
        ...
        if (listening) {
            int newState = SystemProperties.getInt(PROP, 0);
    ...
    protected void handleClick(@Nullable View view) {
        ...
        currentState = STATE_SEQUENCE[(idx + 1) % STATE_SEQUENCE.length];
        SystemProperties.set(PROP, Integer.toString(currentState));
        bumpConfigVersion();
        refreshState();
    }
