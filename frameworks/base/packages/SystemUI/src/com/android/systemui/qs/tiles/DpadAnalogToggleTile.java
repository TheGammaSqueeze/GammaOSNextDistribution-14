...
public class DpadAnalogToggleTile extends QSTileImpl<BooleanState> {
    ...
    private static final String PROP_A2D = "persist.gammaos.gamepad.analog_to_dpad";
    private static final String PROP_D2A = "persist.gammaos.gamepad.dpad_to_analog";
    ...
    public DpadAnalogToggleTile(
        ...
        mEnabled = SystemProperties.getInt(PROP_A2D, 0) != 0;
    }
    ...
    protected void handleSetListening(boolean listening) {
        ...
        if (listening) {
            boolean newEnabled = SystemProperties.getInt(PROP_A2D, 0) != 0;
    ...
    protected void handleClick(@Nullable View view) {
        mEnabled = !mEnabled;
        String val = mEnabled ? "1" : "0";
        SystemProperties.set(PROP_A2D, val);
        SystemProperties.set(PROP_D2A, val);
        bumpConfigVersion();
        refreshState();
    }
