...
public class NetworkShareEditFragment extends SettingsPreferenceFragment {
    ...
    public static NetworkShareEditFragment newInstance(int slot) {
        NetworkShareEditFragment f = new NetworkShareEditFragment();
        Bundle b = new Bundle();
    ...
    private void refresh() {
        ...
        SwitchPreference enabled = new SwitchPreference(getContext());
        ...
        ListPreference type = new ListPreference(getContext());
        ...
        if (!GammaShareConfig.TYPE_NFS.equals(s.type)) {
            Preference port = addText(screen, "share_port", R.string.network_shares_port,
        ...
        if (s.usesCredentials()) {
            ...
            EditTextPreference pass = new EditTextPreference(getContext());
            ...
            Preference note = new Preference(getContext());
        ...
        if (s.supportsTls()) {
            ...
            SwitchPreference tls = new SwitchPreference(getContext());
        ...
        SwitchPreference ro = new SwitchPreference(getContext());
        ro.setKey("share_ro");
        ...
        Preference remove = new Preference(getContext());
    ...
    private EditTextPreference addText(PreferenceScreen screen, String key, int titleRes,
        ...
        EditTextPreference p = new EditTextPreference(getContext());
        p.setKey(key);
        p.setTitle(titleRes);
